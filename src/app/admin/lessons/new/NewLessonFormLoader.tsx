...
export default function NewLessonFormLoader() {
  ...
  const {
    ...
    // Renamed to coursesData to avoid conflict if 'courses' is used elsewhere
  ...
  if (error) {
    return (
      <div className="p-6">
        ...
        <p className="mt-2">
          Cannot add a lesson without a list of courses. Please ensure courses
          are available or try again later.
        </p>
        <Link
          href={
            courseId ? `/admin/courses/${courseId}/lessons` : "/admin/courses"
          }
    ...
    return (
      <div className="p-6">
        ...
        <p className="text-amber-600">
          No courses available. Please create a course first before adding
          lessons.
        </p>

...
} from "@/actions/admin/lesson.actions";
    ...
    return (
      <div>
        <h1 className="text-3xl font-bold mb-6">
          Edit Lesson: {lessonResult.data.title}
        </h1>
        <p className="text-red-500">
          Error fetching courses: {coursesResult.error}
        </p>
        <p>
          Cannot edit the lesson without a list of courses. Please try again
          later.
        </p>
        <Link
          href={
            lessonResult.data
              ? `/admin/courses/${lessonResult.data.course_id}/lessons`
              : "/admin/courses"
          }
    ...
    return (
      <div>
        ...
        <p className="text-orange-500">
          No courses available to assign this lesson to.
        </p>
        <p>
          Please{" "}
          <Link
    ...
    <div>
      <div className="mb-6">
        <Link
          href={
            lesson
              ? `/admin/courses/${lesson.course_id}/lessons`
              : "/admin/courses"
          }
